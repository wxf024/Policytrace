...
async function init(){
 ...
 const typeOf=e=>e._relatedNews?'News':(e.timeline_type||(/protest|riot|public disorder/i.test(e.kind||'')?'Protest':(/government failure|investigation|inquiry|appeal|conviction|court/i.test((e.category||'')+' '+(e.kind||''))?'Court & Investigation':(/statistics|demographic/i.test(e.category||'')?'Statistics':(/immigration|asylum|border/i.test(e.category||'')?'Policy':(/security|crime/i.test(e.category||'')?'Major incident':'News'))))));
